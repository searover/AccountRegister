...
import com.searover.mvnbook.account.captcha.AccountCaptchaException;
import com.searover.mvnbook.account.captcha.AccountCaptchaService;
import com.searover.mvnbook.account.captcha.RandomGenerator;
...
import com.searover.mvnbook.account.persist.Account;
import com.searover.mvnbook.account.persist.AccountPersistException;
import com.searover.mvnbook.account.persist.AccountPersistService;
...
public class AccountServiceImpl implements AccountService {
    ...
    public void signUp(SignUpRequest signUpRequest) throws AccountServiceException {
        try {
            ...
            accountPersistService.create(account);
    ...
    public void activate(String activationId) throws AccountServiceException {
        ...
        try {
            Account account = accountPersistService.read(accountId);
    ...
    public void login(String id, String password) throws AccountServiceException {
        try {
            Account account = accountPersistService.read(id);
            if(account == null){
